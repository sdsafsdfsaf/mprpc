...
example/callee/CMakeFiles/provider.dir/userservice.cc.o: ../example/callee/userservice.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/media/li/D/桌面/job/lecture/mprpc/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object example/callee/CMakeFiles/provider.dir/userservice.cc.o"
	cd /media/li/D/桌面/job/lecture/mprpc/build/example/callee && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/provider.dir/userservice.cc.o -c /media/li/D/桌面/job/lecture/mprpc/example/callee/userservice.cc
...
example/callee/CMakeFiles/provider.dir/userservice.cc.i: cmake_force
	...
	cd /media/li/D/桌面/job/lecture/mprpc/build/example/callee && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /media/li/D/桌面/job/lecture/mprpc/example/callee/userservice.cc > CMakeFiles/provider.dir/userservice.cc.i
...
example/callee/CMakeFiles/provider.dir/userservice.cc.s: cmake_force
	...
	cd /media/li/D/桌面/job/lecture/mprpc/build/example/callee && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /media/li/D/桌面/job/lecture/mprpc/example/callee/userservice.cc -o CMakeFiles/provider.dir/userservice.cc.s
...
example/callee/CMakeFiles/provider.dir/__/user.pb.cc.o: ../example/user.pb.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/media/li/D/桌面/job/lecture/mprpc/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Building CXX object example/callee/CMakeFiles/provider.dir/__/user.pb.cc.o"
	cd /media/li/D/桌面/job/lecture/mprpc/build/example/callee && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/provider.dir/__/user.pb.cc.o -c /media/li/D/桌面/job/lecture/mprpc/example/user.pb.cc
...
example/callee/CMakeFiles/provider.dir/__/user.pb.cc.i: cmake_force
	...
	cd /media/li/D/桌面/job/lecture/mprpc/build/example/callee && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /media/li/D/桌面/job/lecture/mprpc/example/user.pb.cc > CMakeFiles/provider.dir/__/user.pb.cc.i
...
example/callee/CMakeFiles/provider.dir/__/user.pb.cc.s: cmake_force
	...
	cd /media/li/D/桌面/job/lecture/mprpc/build/example/callee && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /media/li/D/桌面/job/lecture/mprpc/example/user.pb.cc -o CMakeFiles/provider.dir/__/user.pb.cc.s
...
../bin/provider: example/callee/CMakeFiles/provider.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/media/li/D/桌面/job/lecture/mprpc/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Linking CXX executable ../../../bin/provider"
	cd /media/li/D/桌面/job/lecture/mprpc/build/example/callee && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/provider.dir/link.txt --verbose=$(VERBOSE)
...
example/callee/CMakeFiles/provider.dir/clean:
	cd /media/li/D/桌面/job/lecture/mprpc/build/example/callee && $(CMAKE_COMMAND) -P CMakeFiles/provider.dir/cmake_clean.cmake
.PHONY : example/callee/CMakeFiles/provider.dir/clean

example/callee/CMakeFiles/provider.dir/depend:
	cd /media/li/D/桌面/job/lecture/mprpc/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /media/li/D/桌面/job/lecture/mprpc /media/li/D/桌面/job/lecture/mprpc/example/callee /media/li/D/桌面/job/lecture/mprpc/build /media/li/D/桌面/job/lecture/mprpc/build/example/callee /media/li/D/桌面/job/lecture/mprpc/build/example/callee/CMakeFiles/provider.dir/DependInfo.cmake --color=$(COLOR)
